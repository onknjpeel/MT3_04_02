...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	Pendulum pendulum{ {0.0f,1.0f,0.0f},0.8f,0.7f,0.0f,0.0f };

	Vector3 p{ pendulum.anchor.x + std::sin(pendulum.angle) * pendulum.length,
	...
	while (Novice::ProcessMessage() == 0) {
		...
		start = Transform(Transform(pendulum.anchor, worldViewProjectionMatrix), viewportMatrix);
